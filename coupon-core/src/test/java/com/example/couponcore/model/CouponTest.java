...
class CouponTest {
    ...
    @Test
    @DisplayName("발급 수량이 남아 있다면 false를 반환")
    void availableIssueQuantity_2() {
        Coupon coupon = Coupon.builder()
                .totalQuantity(100)
                .issuedQuantity(100).build();
    ...
    @Test
    @DisplayName("최대 발급 수랭이 살정되지 않았다면 true 를 반환")
    ...
    @Test
    @DisplayName("발급 수량을 초과허면 예외를 반환한다,.")
    void issue_2() {
        Coupon coupon = Coupon.builder()
                .totalQuantity(100)
                .issuedQuantity(100)
    ...
    void isIssueComplete_1(){
        ...
        Coupon coupon = Coupon.builder()
                ...
                .build();
        //when
        boolean issueComplete = coupon.isIssueComplete();
        //then
        Assertions.assertTrue(issueComplete);
    }
    ...
    @Test
    @DisplayName("발급 기한 과 수량이 유효하면 false를 반환한다.")
    void isIssueComplete_3(){
        ...
        boolean issueComplete = coupon.isIssueComplete();
        //then
        Assertions.assertFalse(issueComplete);
    }
